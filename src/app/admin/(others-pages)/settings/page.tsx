    ...
    <div className="flex flex-1 items-center justify-center rounded-3xl border border-dashed border-gray-300 bg-white/80 p-6 text-center dark:border-gray-700 dark:bg-white/[0.03]">
      <div className="max-w-xl space-y-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          El módulo de configuración se encuentra en desarrollo y estará disponible próximamente.
          Nuestro equipo en Lima está afinando los últimos detalles para ofrecerte una experiencia
          completa.
        </p>
